...
def calculate_inception_stats(
    ...
    data_loader = torch.utils.data.DataLoader(dataset_obj, num_workers=num_workers)
...
@click.option('--out_path', 'fid_out_path', help='Path to write fid', metavar='PATH|ZIP',              type=str, required=False)

def calc(image_path, ref_path, num_expected, seed, batch, fid_out_path=None):
    ...
    if fid_out_path is not None:
        with open(fid_out_path, 'a') as f:
            f.write(f'{fid:g}\n')
